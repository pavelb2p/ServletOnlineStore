    ...
    <div class="row">
        ...
        <div class="col-md-3 my-3">
            <div class="card w-100" style="width: 18rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title"><%= pr.getName()%>
                    </h5>
                    <h6 class="price"><%= pr.getPrice()%>
                    </h6>
                    <h6 class="category"><fmt:message key="cart.category" bundle="${lang}"/> : <%= pr.getCategory()%>
                    </h6>
                    <div class="mt-3 d-flex justify-content-between"></div>
                    <a href="add-to-cart?id=<%= pr.getId()%>" class="btn btn-primary"><fmt:message key="index.buynow"
                                                                                                   bundle="${lang}"/></a>
                </div>
            </div>
        </div>
